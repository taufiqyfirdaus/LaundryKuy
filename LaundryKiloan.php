  ...
  <body style="background-color: rgba(129, 129, 129, 0.2)">
    ...
    <div class="container pt-5 pb-5">
      <div class="text-center">
        <h2 class="mb-5"><b>Jasa Laundry Kiloan</b></h2>
        <img class="text-center mb-4" src="img/kiloanLayanan.jpg" width="900px" height="350px" />
        <p>
          ...
          khusus sesuai dengan jenis bahannya. Dengan layanan laundry Kiloan
          pelanggan tidak perlu khawatir pakaiannya akan terkena
          luntur/kerusakan yang lainnya. Untuk laundry kiloan kami
          memiliki harga yang bervariatif sesuai jenis layanan, Silahkan lihat
        ...
        <table class="table table-bordered" style="background-color: white">
          ...
          <?php
              include "koneksi.php";
              $no = 1;
              $query = "SELECT * FROM layanan WHERE id LIKE 'KL%'";
